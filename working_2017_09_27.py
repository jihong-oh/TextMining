...
thre = 100 # 총등장빈도 frequency 설정. pain에선 100 이상으로 설정했음
...
#text file 에서 랜덤하게 연도, abstract 추출해서 manually curating 할 계획
import random
rand_abs  = random.sample(text_lists,50) #랜덤하게 50개의 abs 추출
...
## relative frequency clustermap 생성(slidind window를 먼저 적용)
